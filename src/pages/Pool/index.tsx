...
function Pool({ user }: { user: string }) {
  ...
  useEffect(() => {
    if (user === "") {
      ...
      setPairBalanceCLP(new BigNumber(0));
    ...
    async function updateUserInfo() {
      ...
      const poolTotalBonded = toTokenUnitsBN(poolTotalBondedStr, CLP.decimals);
      const pairCLPBalance = toTokenUnitsBN(pairBalanceCLPStr, CLP.decimals);
      ...
      const userRewardedBalance = toTokenUnitsBN(rewardedBalance, CLP.decimals);
      ...
      if (!isCancelled) {
        ...
        setPairBalanceCLP(new BigNumber(pairCLPBalance));
      ...
      <>
        ...
        <Row title="LP Reward Pool">
          <PoolPageHeader
            ...
            accountRewardedCLPBalance={userRewardedBalance}
            accountClaimableCLPBalance={userClaimableBalance}
